...
void Lcd_Cmd_8bits(unsigned char comando);
...
void main(void) {
    ...
    initOsc(7);
    Lcd_Init_8bits();
# 90 "MainSPIRaspMaster.c"
    Lcd_Set_Cursor_8bits(1,1);
    Lcd_Write_String(" S1:   S2:  S3: ",8);

    Lcd_Set_Cursor_8bits(2,3);
    Lcd_Write_String("S",8);
    Lcd_Set_Cursor_8bits(2,7);
    Lcd_Write_String(".",8);

    Lcd_Set_Cursor_8bits(2,9);
    Lcd_Write_Char(223,8);
    Lcd_Set_Cursor_8bits(2,10);
...
# 128 "MainSPIRaspMaster.c"
        ...
        ConvNum(data1,2);
        ConvNum(data2,1);
# 145 "MainSPIRaspMaster.c"
        Lcd_Set_Cursor_8bits(2,5);
        Lcd_Write_String("2",8);

         Lcd_Set_Cursor_8bits(2,6);
        Lcd_Write_String("6",8);

         Lcd_Set_Cursor_8bits(2,8);
        Lcd_Write_String("4",8);


        if (valor1 == 1){
            Lcd_Set_Cursor_8bits(2,14);
            Lcd_Write_String("ON ",8);
            PORTCbits.RC0 =1;
        }else {
            Lcd_Set_Cursor_8bits(2,14);
            Lcd_Write_String("OFF",8);
            PORTCbits.RC0 =0;
        }
